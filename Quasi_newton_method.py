...
class Quasi_newton_method(object):
    ...
    #search method. Takes as input x_k, s_k, some left/right conditions, upper/lower bounds for acceptible points, the objective function as well as its gradient in (x + a*s) and method parameters ro, tau, chi and (sometimes) sigma.    
